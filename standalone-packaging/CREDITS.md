...
(see `CONTRIBUTORS.txt`). This game is a GPLv3 fork of Forge, pinned to the
2.0.15 development line. Without Forge, none of this exists.
...
building/boss artwork, and starter deck concepts.
...
(`LICENSE.txt`). Complete modified source: https://github.com/TheSAguy/mtg-forge-mod
