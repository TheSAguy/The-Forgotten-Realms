...
file. All new log lines share the prefix `[TFR-` (for "The Forgotten Realms") so the whole batch is
findable at once: `grep "\[TFR-" forge.log` (PowerShell: `Select-String '\[TFR-' forge.log`).
